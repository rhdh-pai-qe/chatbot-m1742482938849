...
3) Access the `workbench` named `chatbot-m1742482938849-notebook`.
...
5) In the terminal, run `cd chatbot-m1742482938849` to navigate to your sample app's directory.
